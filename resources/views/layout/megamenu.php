         ...
         Academics
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <ul>
              ...
              <li><a class="dropdown-item" href="/academics/canr">College of Agr</a></li>
              <li><a class="dropdown-item" href="#">Mega Menu Link</a></li>
              <li><a class="dropdown-item" href="#">Mega Menu Link</a></li>
            </ul>
            <ul>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <ul>
              ...
              <li><a class="dropdown-item" href="/whatisnew/news">News</a></li>
              <li><a class="dropdown-item" href="#">Mega Menu Link</a></li>
              <li><a class="dropdown-item" href="#">Mega Menu Link</a></li>
              <li><a class="dropdown-item" href="#">Mega Menu Link</a></li>
            </ul>
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <ul>
              <li><a class="dropdown-item" href="locale/am">Amharic</a></li>
